...
#/home/jason/git_repositories/HandBrake_Scripts/HB_DashCam_Converter_Rename_Create_Date_Worker.sh
...
filenamemp4=DashCam_${ModDate2}.mp4
#echo $filename
rootname=$(basename $1)
echo
#echo $1
#echo $rootname
#echo
#rootnamemp4=${1%rootname/AVI/mp4}
fullfilename=${1%$rootname}$filename
#echo $fullfilename
#echo
echo Renaming $1 to $fullfilename
mv -T $1 $fullfilename
#echo test run: mv -T "$1" "$fullfilename"
echo Exit code $?
echo
